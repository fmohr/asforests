...
class TestDatabaseBasedApproach(TestCase):
    ...
    def test_approximation_correctness(self):
        ...
        # approximate ground truth
        t_start = time()
        approx_mean, approx_var = gt.approximate_true_parameters_in_iid_setting_by_sampling(t=t, n=n, num_samples=10**6, num_samples_per_job=(10**6)//5, n_jobs=1)
        t_end = time()
