...
def run_experiment(keyfields: dict, result_processor: ResultProcessor, custom_config):
    ...
    drop = None if openmlid in [3, 38, 46, 57, 179, 180, 188, 231, 315, 897, 930, 953, 993, 1000, 1002, 1111, 1018, 1037, 1116, 1119, 1590, 4135, 4541, 40701, 40981, 41021, 41142, 41162, 41143, 42563, 42570, 42571, 42688, 42727, 42729, 42732, 42733, 42734] else 'first'
